                        ...
                        <form ref="form" @submit.prevent="validateForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3 text-wrap">
                                    ...
                                    <vue-editor  v-model="amenities"></vue-editor>
                                ...
                                <div class="mb-3">
                                    ...
                                    <vue-editor  v-model="pricing"></vue-editor>
                                ...
                                <div class="mb-3 text-wrap">
                                    ...
                                    <vue-editor  v-model="availability"></vue-editor>
                                ...
                                <div class="mb-3 text-wrap">
                                    ...
                                    <vue-editor  v-model="food"></vue-editor>
