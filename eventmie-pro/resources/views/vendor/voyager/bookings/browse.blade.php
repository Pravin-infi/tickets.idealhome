                                        ...
                                        <tr>
                                                    ...
                                                    @elseif(($row->type == 'select_dropdown' || $row->type == 'radio_btn') && property_exists($row->details, 'options'))
                                                        @if ($row->getTranslatedAttribute('display_name') == 'Booking Cancel')
                                                            ...
                                                            @else
                                                                ...
                                                                {{ __('voyager::generic.cancellation') }}
                                                            @endif
                                                        @endif
                                            ...
                                            <td class="no-sort no-click" id="bread-actions">
                                                ...
                                                <a href="javascript:;" title="{{ __('voyager::generic.delete') }}"
                                                    class="btn btn-sm btn-danger delete pull-right"
                                                ...
                                                <a href="{{ route('eventmie.obookings_organiser_bookings_show', [$data->id]) }}"
                                                    class="btn btn-sm btn-warning view pull-right">
                                                    <i class="voyager-eye"></i> <span
                                                        class="hidden-xs hidden-sm">{{ __('voyager::generic.view') }}</span>
                                                </a>

                                                <a href="{{ route('eventmie.downloads_index', [$data->id, $data->order_number]) }}"
                                                    class="btn btn-sm btn-success download pull-right">
                                                    <i class="voyager-download"></i> <span
                                                        class="hidden-xs hidden-sm">{{ __('voyager::generic.download') }}</span>
                                                </a>

                                                {{-- Single delete modal --}}
                                                <div class="modal modal-danger fade" tabindex="-1"
                                                    id="delete_modal{{ $data->id }}" role="dialog">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form
                                                                    action="{{ route('eventmie.obookings_organiser_booking_delete', [$data->id]) }}"
                                                                    id="delete_form" method="GET">
                                                                    {{ csrf_field() }}
                                                                    <input type="submit"
