                                    ...
                                    >
                                        ...
                                        <td :data-title="trans('em.actions')" class="text-nowrap">
                                            <div class="btn-group">
                                                ...
                                                <button type="button" class="btn btn-sm btn-success" @click="eventReminder(ticket.id)"><i class="fas fa-envelope"></i> Event Reminder</button>
...
export default {
    ...
    methods: {
        ...
        // event Reminder tickets
        eventReminder(ticket_id){
            this.showConfirm(trans('em.ask_event_reminder')).then((res) => {
                if(res) {
                    axios.post(route('eventmie.bookingReminder'), {
                        ticket_id       : ticket_id,
                    })
                    .then(res => {
                        ...
                        if(res.data.status)
                        {
                            this.showNotification('success', trans('em.done_event_reminder'));
                            this.getTickets();
                        }
                    })
                    .catch(error => {
