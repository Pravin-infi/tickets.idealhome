                                ...
                                <tr  v-for="(glist, index) in glists" :key="index" >
                                    ...
                                    <td>
                                        <div class="custom-dropdown " v-on:click="isOpen = isOpen === index ? null : index">
                                            <a class="btn btn-primary"  href="javascript:void(0)" role="button" id="courseDropdown2"><i class="fas fa-ellipsis-vertical" ></i> </a>
                                              <ul  class="dropdownmenu shadow-lg" v-if="isOpen === index">
                                                ...
                                                <li>
                                                    <a class="btn btn-danger btn-sm" href="javascript:void(0)" @click="deleteGlist(glist.id)"><i class="fas fa-trash-alt"></i> {{ trans('em.delete') }}</a>
                                                </li>
                                            </ul>
                                        </div>
                                </td>
