            ...
            <div class="col-md-12">
                ...
                @if (!$isOrgDash)
                    <div class="row statistics">
                        ...
                        @foreach ($total_revenue as $val)
                            <div class="col-md-3">
                                <div class="box">
                                    <i class="voyager-dollar text-center"></i>
                                    <div class="info">
                                        <h3>{{ $val['total_revenue'] . ' ' . $val['currency'] }}</h3>
                                        <p>{{ $val['currency'] }} {{ __('voyager::generic.Revenue') }}</p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="searchInput"
                                                @input="GetEvents('searchInput','event_id')" class="form-control mb-3"
                                                placeholder="Type to search">

                                            <select class="form-control" name="event_id" id="event_id" size="7">
