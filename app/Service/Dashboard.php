...
class Dashboard extends Controller
{
    ...
    {  
        ...
        foreach($sales_report as  $key => $item) 
        {
            ...
            $csvData[$key]['Customer Name']  = $item['customer_name'];
            $csvData[$key]['Email']  = $item['customer_email'];
            ...
            $csvData[$key]['Promocode']    = $item['promocode'] ?? '';

            $csvData[$key]['Visit Day']    = $item['visit_show_day'] ?? '';//visit_show_day

            $csvData[$key]['Direct connect']  =  $item['direct_connect_attendee'] > 0 ? __('eventmie-pro::em.yes') : __('eventmie-pro::em.no') ;//direct_connect_attendee
        ...
        $csvData[count($sales_report) + 1]['Customer Name'] = null;
        $csvData[count($sales_report) + 1]['Email'] = null;
        ...
        $csvData[count($sales_report) + 1]['Promocode']  = '';
        $csvData[count($sales_report) + 1]['Visit Day']  = '';

        $csvData[count($sales_report) + 1]['Direct connect']  = '';
