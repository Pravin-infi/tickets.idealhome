...
class SendEmailController extends BaseSendEmailController
{
    ...
    public function send_email(Request $request)
    {
        ...
        $mail['mail_subject']   = 'Your Tickets for The PTSB Ideal Home Show';
        ...
        // $notification_ids       = [1, $booking_data[key($booking_data)]['organiser_id'], $booking_data[key($booking_data)]['customer_id']]; // mail sent only user
    ...
    public function send_reminder_email($reminderData)
    {
        ...
        // get online event info
        $event = $this->event->get_event(NULL, $reminderData['event_id']);
        $mail['is_online']      = FALSE;
        if(!empty($event->online_location))
            $mail['is_online']  = TRUE;
        ...
        // ====================== Notification ====================== 
        //send notification after bookings
        $mail['mail_data'][]      = $reminderData;
        $mail['action_title']   = __('eventmie-pro::em.download_tickets');
        $mail['action_url']     = route('eventmie.mybookings_index');
        $mail['mail_subject']   = 'Reminder! Tickets for The PTSB Ideal Home Show';
        $mail['n_type']         = "bookings";
        ...
        $notification_ids       = [$reminderData['customer_id']];
